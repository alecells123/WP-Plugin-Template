...
class Wp_Plugin_Template {
	 ...
	 *
	 * - Wp_Plugin_Template_Loader. Orchestrates the hooks of the plugin.
	 * - Wp_Plugin_Template_i18n. Defines internationalization functionality.
	 * - Wp_Plugin_Template_Admin. Defines all hooks for the admin area.
	 * - Wp_Plugin_Template_Public. Defines all hooks for the public side of the site.
	 *
